...
export const UserDetails = ({ id, type, subAccounts, userData }: Props) => {
  ...
  const onChangePermission = async (
    ...
    const response = await changeUserPersmissions(
  ...
  return (
    <Card className=" w-full">
      <CardHeader>
        ...
        <CardDescription>Addd or update your information</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      if (
                        ...
                        setRoleState(
                          "You need to have subaccounts to assing subaccount access to team members."
                        );
                      } else {
                        setRoleState("");
                      }
