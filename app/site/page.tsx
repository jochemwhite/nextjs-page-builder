  ...
  return (
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col ">
        ...
        <div className="flex justify-center relative md:mt-[-70px]">
          <Image
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-[-40px]">
        <h2 className="text-4xl text-center">Chosee what fits your right</h2>
        <p className="text-muted-foreground text-center">
          Our straigthforward pricing plans are tailored to meet your needs. If
