...
import { CreateSubAccountButton } from "./_components/create_subaccount_button";

type Props = {
  params: { agencyId: string };
};

export default async function AllSubAccounsPage({ params }: Props) {
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="text-left">
                          This action canot be undo. This will delete the
